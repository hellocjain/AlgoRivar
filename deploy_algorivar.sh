#!/usr/bin/env bash
# ==============================================================================
# AlgoRivar + AC Agarwal Broker (Symphony XTS) Interactive One-Shot Installer
# ==============================================================================
set -e
...
echo -e "${CYAN}"
echo "======================================================================"
echo "      AlgoRivar v2.0 + AC Agarwal Broker One-Shot Installer            "
echo "======================================================================"
echo -e "${NC}"
...
INSTALL_DIR="${INSTALL_DIR:-/opt/algorivar}"
...
# ------------------------------------------------------------------------------
echo -e "\n${CYAN}--- Step 3: Preparing AlgoRivar Repository ---${NC}"
if [ ! -d "$INSTALL_DIR" ]; then
  echo -e "${GREEN}[+] Cloning AlgoRivar repository into ${INSTALL_DIR}...${NC}"
  git clone https://github.com/hellocjain/algorivar-acagarwal.git "$INSTALL_DIR"
else
...
# Generate mandatory AlgoRivar v2.0 security tokens if absent
...
SERVICE_FILE="/etc/systemd/system/algorivar.service"

cat <<EOF > $SERVICE_FILE
[Unit]
Description=AlgoRivar Algorithmic Trading Platform (AC Agarwal Broker)
...
systemctl enable algorivar
systemctl restart algorivar

echo -e "\n${GREEN}======================================================================${NC}"
echo -e "${GREEN}  ✓ AlgoRivar Installation Completed Successfully!                     ${NC}"
echo -e "${GREEN}======================================================================${NC}"
echo -e "${CYAN}Web Portal URL :${NC} http://${STATIC_IP}:5001"
echo -e "${CYAN}Admin Username :${NC} ${ADMIN_USERNAME}"
echo -e "${CYAN}Service Status :${NC} sudo systemctl status algorivar"
echo -e "${CYAN}Live Logs      :${NC} sudo journalctl -u algorivar -f"
echo -e "${GREEN}======================================================================${NC}\n"
