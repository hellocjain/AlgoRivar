...
print("\n" + "="*70)
print("     AlgoRivar + AC Agarwal Master Broker Configuration Wizard")
print("                  Tagline: Algo Trading Made Easy")
print("="*70)
...
print("\nRestarting AlgoRivar Service...")
try:
    subprocess.run(["sudo", "systemctl", "restart", "algorivar"], check=False)
    print("  [✓] systemctl restart algorivar executed.")
except Exception:
    pass

print("\n" + "="*70)
print("  🎉 Configuration Complete! AlgoRivar is live and ready.")
print("="*70)
print(f"Master Desk Hub:   http://127.0.0.1:5001/copytrading")
print(f"Retail Client Hub: http://127.0.0.1:5001/portal")
